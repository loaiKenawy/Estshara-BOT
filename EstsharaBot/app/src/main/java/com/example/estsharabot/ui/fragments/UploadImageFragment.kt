...
class UploadImageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnUpload.setOnClickListener {
            Constants.IMAGE_BASE_URL = getAPI()
    ...
    private suspend fun uploadFile(uri: Uri) {
        ...
        try {
            viewModel = ViewModelProvider(
                this,
                MainViewModelFactory(RemoteRepo(Service.getInstance2()!!))
            ...
            try {
                ...
                val requestBody: RequestBody = MultipartBody.Builder()
                    ...
                    .build()
                viewModel.postImage(requestBody).observe(this, Observer {
                    Toast.makeText(context, Constants.UPLOAD_DONE, Toast.LENGTH_SHORT).show()
                    binding.tvValueOrgan.text = it.organ
                    binding.tvValueType.text = it.disease
                    binding.pbRisk.progress = 93
                    val percentageTemp = "93" + "%"
